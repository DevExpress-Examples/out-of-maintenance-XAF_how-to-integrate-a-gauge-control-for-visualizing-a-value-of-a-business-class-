...
Namespace GaugePropertyEditor.Web
	<PropertyEditor(GetType(String), "DigitalGaugePropertyEditor", False)>
	Public Class DigitalGaugePropertyEditor
		...
		Protected Overrides Function GetControlValueCore() As Object
			Return DirectCast(BindableComponent, DigitalGauge).Text
		End Function
		Protected Overrides Sub ReadValueCore()
			DirectCast(BindableComponent, DigitalGauge).Text = Convert.ToString(PropertyValue)
		End Sub
	End Class
End Namespace
