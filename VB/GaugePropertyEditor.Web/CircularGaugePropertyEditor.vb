...
Namespace GaugePropertyEditor.Web
	<PropertyEditor(GetType(Single), "CircularGaugePropertyEditor", False)>
	Public Class CircularGaugePropertyEditor
		...
		Protected Overrides Function GetControlValueCore() As Object
			Return DirectCast(BindableComponent, ArcScaleComponent).Value
		End Function
		Protected Overrides Sub ReadValueCore()
			DirectCast(BindableComponent, ArcScaleComponent).Value = Convert.ToSingle(PropertyValue)
		End Sub
	End Class
End Namespace
