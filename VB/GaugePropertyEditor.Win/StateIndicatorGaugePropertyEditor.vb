...
Namespace GaugePropertyEditor.Win
	<PropertyEditor(GetType(System.Enum), "StateIndicatorGaugePropertyEditor", False)>
	Public Class StateIndicatorGaugePropertyEditor
		...
		Protected Overrides Function GetControlValueCore() As Object
			Return DirectCast(BindableComponent, StateIndicatorComponent).StateIndex
		End Function
		Protected Overrides Sub ReadValueCore()
			DirectCast(BindableComponent, StateIndicatorComponent).StateIndex = Convert.ToInt32(PropertyValue)
		End Sub
	End Class
End Namespace
